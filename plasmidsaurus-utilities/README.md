...
Presently can run it at sessions luanched from [here](https://github.com/fomightez/cl_demo-binder) that include biopython installed. (I'm not sure launches from the seemingly more appropriate [repo 'cl_sq_demo-binder'](https://github.com/fomightez/cl_sq_demo-binder) are presently failing.)

...
- You can use `blastdbcmd` to extract FASTA-formatted sequences and sequence ranges from the BLAST databases, see ['Extract different sequence ranges from the BLAST databases' in 'Extracting data from BLAST databases with blastdbcmd'](https://www.ncbi.nlm.nih.gov/books/NBK569853/). This could prove handy for following up.

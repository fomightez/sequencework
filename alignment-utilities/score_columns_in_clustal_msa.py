...
# genetic elements or protein paralogs/orthologs/gene family members/gene 
# cluster members in order to objectively  assess which of the related elements
# are more highly conserved overall given what a particular 'score' emphasizes. 
# Mainly meant to be a rough guide to replace (or confirm) visual inspection.
#

...
# calculate_cons_for_clustal_nucleic.py  by 
# Wayne Decatur
# ver 0.1
#
#*******************************************************************************
...
#-----------------------------------
# python calculate_cons_for_clustal_nucleic.py msa.txt 
#-----------------------------------
#
# Issue `calculate_cons_for_clustal_nucleic.py  -h` for details.
# 
#
#
...
# calculate_cons_for_clustal_nucleic("msa.clustal")
# 
#-or-
...
# calculate_cons_for_clustal_nucleic(test.out,name_basis="rt_arm_chrV_sensu.clustal")
...
def main():
    ...
    calculate_cons_for_clustal_nucleic(alignment,**kwargs)
...
if __name__ == "__main__" and '__file__' in globals():
    ...
    parser = argparse.ArgumentParser(prog=
        'calculate_cons_for_clustal_nucleic.py ',
        description="calculate_cons_for_clustal_nucleic.py  \

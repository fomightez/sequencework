...
# score_sequences_in_clustal_msa.py  by 
# Wayne Decatur
# ver 0.1
#
#*******************************************************************************
...
# score for each sequence in the alignment.
#
#
# 
#
...
#
#
# If you are Wayne, see `scoring individual sequences in multiple sequence 
# alignments MSA.md` for specific impetus behind this script.
# Based on `calculate_cons_for_clustal_nucleic.py`, but limited to being 
# concerned with 'majority' line.
#
#
#
#
...
#
# to do:
# - since this is based on `calculate_cons_for_clustal_nucleic.py` it inherits
...
#-----------------------------------
# python score_sequences_in_clustal_msa.py msa.txt 
#-----------------------------------
#
# Issue `score_sequences_in_clustal_msa.py  -h` for details.
# 
#
#
...
# score_sequences_in_clustal_msa("msa.clustal")
# 
#-or-
...
# score_sequences_in_clustal_msa(test.out,name_basis="rt_arm_chrV_sensu.clustal")
...
from score_sequences_in_clustal_msa import score_sequences_in_clustal_msa
score_sequences_in_clustal_msa("msa.clustal")
'''
#
#
...
suffix_for_saving = "_maj_match_scores" #to be used for naming the output 
...
def generate_output_file_name(file_name,suffix_for_saving):
    ...
    Calling function with
        ("alignment.clustal")
    returns
        "alignment_maj_match_scores.tsv"
    '''
...
def score_sequences_in_clustal_msa(
    alignment, 
    ...
    # `majority` will simply be what is the majority at that position and  
    # be used in another script (my pretty msa one) for determining if 
    # nucleotides represented as bold.  
    # Here it will be used in the scoring!
    sys.stderr.write("determining what is majority at each position of "
        "aligned sequences...")
    majority = ""
...
def main():
    ...
    score_sequences_in_clustal_msa(alignment,**kwargs)

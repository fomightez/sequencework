#!/usr/bin/env python
# mine_SUTs_and_merge_into_mito_transcripts_df.py
__author__ = "Wayne Decatur" #fomightez on GitHub
__license__ = "MIT"
__version__ = "0.1.0"


# mine_SUTs_and_merge_into_mito_transcripts_df.py by Wayne Decatur
# ver 0.1
#
#*******************************************************************************
...
# `mine_mito_features_from_transcriptome.py` on a file of the Ensembl cDNAs + 
# Ensembl ncRNAs (plus some custom RNAs I added) as the transcriptome.
#
...
#-----------------------------------
# python mine_SUTs_and_merge_into_mito_transcripts_df.py
#-----------------------------------
...
# `df = mine_and_mergeSUTs(pickle_df = False)` to 
...
if __name__ == "__main__" and '__file__' in globals():
    ...
    import argparse
    parser = argparse.ArgumentParser(prog='mine_SUTs_and_merge_into_mito_transcripts_df.py',
        description="mine_SUTs_and_merge_into_mito_transcripts_df.py  takes  \
